...
- `synthesized_result` MUST be written in Simplified Chinese (简体中文).
- Allowed exceptions: code, URLs, proper nouns/brand names, citations/source titles.
- If `original_goal` explicitly requires another language, follow that requirement.
