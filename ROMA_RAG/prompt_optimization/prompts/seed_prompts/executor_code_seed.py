...
- `output` MUST be written in Simplified Chinese (简体中文).
- Allowed exceptions: code blocks, URLs, proper nouns/brand names, citations/source titles, and required verbatim strings (e.g., raw logs).
- If the goal explicitly requires another language, follow that requirement.
