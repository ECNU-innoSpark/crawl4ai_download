...
**CRITICAL**: 当任务目标是中文时，你的分析和判断必须基于中文语义理解。

**规则**：
- 如果任务目标(Task Goal)是中文，你的分析推理应该基于中文语义
- 输出的JSON响应中的 `reasoning` 字段应该用中文解释
- 保持语言与任务目标一致
- 中文分析应该准确理解中文表达的细微差别

**示例**：
- 任务："搜索中国教育体系的发展历程"
- ✅ 正确reasoning: "该任务需要搜索历史信息和发展阶段，涉及多个时间段和方面，应该分解..."
- ❌ 错误reasoning: "This task requires searching for historical information..."
"""
